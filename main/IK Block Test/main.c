...
int main() {
	...
	ik_test_case(&prn, (vec3) { 2.f, 3.f, 1.f }, (vec3){0.f, 1.f,0.f});

	printf("Move just the second motor\n");
	ik_test_case(&prn, (vec3) { 2.f, 3.f, 2.f }, (vec3) { 0.f, 1.f, 0.f });

	printf("Move just the third motor\n");
	ik_test_case(&prn, (vec3) { 2.f, 4.f, 2.f }, (vec3) { 0.f, 1.f, 0.f });

	printf("Move in the Z axis\n");
	ik_test_case(&prn, (vec3) { 2.f, 4.f, 2.f }, (vec3) { 1.f, 1.f, 0.f });

	printf("Move in the X axis\n");
	ik_test_case(&prn, (vec3) { 2.f, 4.f, 2.f }, (vec3) { 1.f, 1.f, 1.f });

	printf("Move all at once\n");
	ik_test_case(&prn, (vec3) { 4.f, 2.f, 4.f }, (vec3) { -1.f, -1.f, -1.f });
